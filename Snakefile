...
mockmag = ['BiolstdMockMag', 'BiolstdWWMockMag', 'WWMockMag']
mocknomag = ['BiolstdMockNomag', 'BiolstdWWMockNomag', 'WWMockNomag']
nomockmag = ['BiolstdNomockMag', 'BiolstdWWNomockMag', 'WWNomockMag']
nomocknomag = ['BiolstdNomockNomag', 'BiolstdWWNomockNomag', 'WWNomockNomag']
...
rule draw_abundance_comparisons:
  ...
  params:
    {'Type' : 'bacteria',
     'Samples' : mockmag + mocknomag + nomockmag + nomocknomag,
...
rule draw_tanglegrams:
  ...
  output:
    "figures/mockmag.png",
    "figures/mockmag_normalised.png",
    "figures/mocknomag.png",
    "figures/mocknomag_normalised.png",
    "figures/nomockmag.png",
    "figures/nomockmag_normalised.png",
    "figures/nomocknomag.png",
    "figures/nomocknomag_normalised.png"
  params:
    {'Samples' : mockmag,
     'Colors' : colors,
